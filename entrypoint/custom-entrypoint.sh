...
conf_set ckan.site_title "IT-IOOS"
conf_set ckan.site_description "This is the portal of the Itineris WP5 Marine domain."
...
conf_set ckan.default.package_type "itoos-data" # CKAN > 2.9
